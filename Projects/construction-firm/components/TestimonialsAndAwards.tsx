...
export default function TestimonialsAndAwards() {
  ...
  const awards = [
    ...
    { title: "Chứng Nhận An Toàn OHSAS 18001 / ISO 45001", body: "Kỷ kỷ lục 15 triệu giờ làm việc an toàn không xảy ra bất kỳ sự cố lao động nào." },
  ];
          ...
          {reviews.map((rev, idx) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-[#334155] space-y-1">
                <p className="font-heading font-bold text-sm uppercase text-white">{rev.author}</p>
