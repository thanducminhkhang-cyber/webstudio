...
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@wsos/ui/components/card";
...
import { MagicCard } from "@wsos/ui/blocks/magic-card";
...
export default function CafeShowcase() {
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground transition-colors duration-300">
      {/* Toast notification */}
      {toastMessage && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-xl bg-amber-500 text-slate-950 px-5 py-4 font-medium shadow-2xl animate-in slide-in-from-bottom-5">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#hero" className="flex items-center gap-2 group">
            <div className="h-9 w-9 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center text-amber-500 group-hover:scale-105 transition-transform">
              <Coffee className="h-5 w-5" />
            </div>
            <span className="font-heading font-extrabold text-xl tracking-wider text-foreground">
              KISSATEN <span className="text-amber-500 font-light text-xs tracking-normal">喫茶店</span>
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a href="#booking">
              <ShimmerButton className="text-xs font-semibold px-4 py-2">
                Đặt Bàn Ngay
              </ShimmerButton>
            </a>
          </div>
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="bg-background/95 backdrop-blur-xl border-border">
                <SheetHeader>
                  <SheetTitle className="text-left font-heading text-xl text-amber-500">
                    KISSATEN TOKYO
                  </SheetTitle>
                </SheetHeader>
                <div className="flex flex-col gap-6 mt-8 font-medium text-lg">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 px-6 overflow-hidden">
        <DotPattern className="absolute inset-0 opacity-25" />
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8">
          <BlurFade delay={0.1}>
            <Badge variant="outline" className="px-4 py-1.5 border-amber-500/40 text-amber-400 bg-amber-500/10 rounded-full text-xs uppercase tracking-widest">
          ...
          <BlurFade delay={0.2}>
            <h1 className="font-heading text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-none text-foreground">
              ...
              <TypingAnimation className="mt-2 text-2xl sm:text-4xl text-slate-300 font-light">
          ...
          <BlurFade delay={0.4}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <a href="#booking">
                <ShimmerButton className="px-8 py-3.5 text-sm font-bold tracking-wide shadow-xl">
                  Đặt Bàn Trực Tuyến
                </ShimmerButton>
              </a>
              <a href="#menu">
                <Button variant="outline" className="px-6 py-3.5 border-border hover:bg-accent text-foreground text-sm font-medium rounded-xl">
                  Khám Phá Menu
          ...
          <BlurFade delay={0.5}>
            <div className="relative mt-12 max-w-4xl mx-auto rounded-2xl overflow-hidden border border-border/60 shadow-2xl group">
              ...
              <div className="relative h-64 sm:h-96 w-full overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end text-left">
                  <div>
                    <p className="text-xs text-amber-400 font-mono tracking-widest">SPECIALTY BREW BAR</p>
                    <h3 className="font-heading text-xl sm:text-2xl font-bold text-white">Ginza 108, Tokyo</h3>
                  </div>
                  <Badge variant="secondary" className="backdrop-blur-md bg-black/40 border border-white/10 text-white">
                    Open till 02:00 AM
                  </Badge>
                </div>
              </div>
      ...
      <section id="about" className="py-20 px-6 border-y border-border/40 bg-accent/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <BlurFade delay={0.2}>
              <div className="space-y-6">
                ...
                <h2 className="font-heading text-3xl sm:text-4xl font-bold leading-tight">
                  ...
                  <span className="text-amber-400">Cầu Kỳ Trong Hương Vị.</span>
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  Kissaten ra đời từ niềm đam mê văn hoá Kissaten Nhật Bản thập niên 70 kết hợp phong cách rang xay hiện đại. Mỗi hạt cà phê tại Kissaten đều trải qua quy trình lên men yếm khí nghiêm ngặt, chiết xuất tỉ mỉ để giữ trọn vẹn hương hoa và trái cây chín mọng.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Chúng tôi tin rằng một tách cà phê hoàn hảo không chỉ đến từ nguyên liệu chất lượng cao mà còn từ khoảng không tĩnh lặng giúp bạn thư thái sau những giờ làm việc căng thẳng.
                </p>
              </div>
            </BlurFade>
            ...
            <BlurFade delay={0.3}>
              <div className="grid grid-cols-2 gap-4">
                <Card className="bg-background/60 backdrop-blur-sm border-border p-6 text-center">
                  <h3 className="font-heading text-3xl sm:text-4xl font-extrabold text-amber-400 flex items-center justify-center">
                    <NumberTicker value={8} />+
                  </h3>
                  <p className="text-xs text-muted-foreground mt-2 font-medium">Năm Rang Xay Thủ Công</p>
                </Card>
                ...
                <Card className="bg-background/60 backdrop-blur-sm border-border p-6 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-2 font-medium">Tách Cà Phê Đã Phục Vụ</p>
                </Card>
                ...
                <Card className="bg-background/60 backdrop-blur-sm border-border p-6 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-2 font-medium">Arabica Cầu Đất & Yirgacheffe</p>
                </Card>
                ...
                <Card className="bg-background/60 backdrop-blur-sm border-border p-6 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-2 font-medium">Đánh Giá Hài Lòng</p>
                </Card>
              </div>
            </BlurFade>
          </div>
      ...
      <section id="menu" className="py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center space-y-4 mb-12">
          ...
          <BlurFade delay={0.2}>
            <h2 className="font-heading text-3xl sm:text-5xl font-bold">Thực Đơn Độc Bản</h2>
          </BlurFade>
          <BlurFade delay={0.3}>
        ...
        <Tabs defaultValue="coffee" className="w-full">
          <div className="flex justify-center mb-10">
            <TabsList className="bg-accent/40 border border-border p-1 rounded-2xl grid grid-cols-2 md:grid-cols-4 gap-1">
              <TabsTrigger value="coffee" className="rounded-xl font-medium text-xs sm:text-sm px-4 py-2">
                ☕ Cà Phê Specialty
              </TabsTrigger>
              <TabsTrigger value="tea" className="rounded-xl font-medium text-xs sm:text-sm px-4 py-2">
                🍵 Trà Nhật Bản
              </TabsTrigger>
              <TabsTrigger value="pastry" className="rounded-xl font-medium text-xs sm:text-sm px-4 py-2">
                🥐 Bánh Ngọt
              </TabsTrigger>
              <TabsTrigger value="specialty" className="rounded-xl font-medium text-xs sm:text-sm px-4 py-2">
                🍸 Signature Mocktail
              </TabsTrigger>
            </TabsList>
          </div>
          ...
          {Object.entries(MENU_DATA).map(([category, items]) => (
            <TabsContent key={category} value={category} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {items.map((item) => (
                  <Card key={item.id} className="bg-card/40 border-border hover:border-amber-500/40 transition-all duration-300 overflow-hidden flex flex-col sm:flex-row group">
                    ...
                    <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                      <div>
                        <div className="flex justify-between items-start gap-2">
                          <div>
                            ...
                            <p className="text-xs text-amber-500/80 font-mono">{item.jpName}</p>
                          </div>
                      ...
                      {item.badge && (
                        <div>
                          <Badge variant="secondary" className="bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[10px]">
                            {item.badge}
                          </Badge>
                        </div>
                      )}
      ...
      {/* SECTION 4: GALLERY */}
      <section id="gallery" className="py-20 px-6 border-t border-border/40 bg-accent/10">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <Badge variant="outline" className="border-amber-500/30 text-amber-400">
              ATMOSPHERE GALLERY
            </Badge>
            <h2 className="font-heading text-3xl sm:text-4xl font-bold">Không Gian Trải Nghiệm</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
      ...
      <section id="booking" className="py-24 px-6 max-w-4xl mx-auto relative">
        <div className="text-center space-y-4 mb-10">
          ...
          <h2 className="font-heading text-3xl sm:text-5xl font-bold">Đặt Bàn Trực Tuyến</h2>
          <p className="text-muted-foreground">
            Đặt bàn trước để đảm bảo vị trí ưa thích của bạn tại Kissaten Tokyo.
          </p>
        </div>

        <Card className="relative bg-card/60 backdrop-blur-xl border-border p-6 sm:p-10 shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleBookSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-background/80 border-border focus:border-amber-500"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="date" className="text-sm font-medium">Ngày Đặt</Label>
                <Input
                  id="date"
                  type="date"
                  value={formData.date}
              ...
              <div className="space-y-2">
                <Label htmlFor="time" className="text-sm font-medium">Giờ Đặt</Label>
                <Input
                  id="time"
                  type="time"
                  value={formData.time}
            ...
            <div className="space-y-2">
              <Label htmlFor="guests" className="text-sm font-medium">Số Lượng Khách</Label>
              <select
                id="guests"
                value={formData.guests}
                onChange={(e) => setFormData({ ...formData, guests: e.target.value })}
                className="w-full h-10 px-3 rounded-md bg-background/80 border border-border text-foreground text-sm focus:outline-none focus:border-amber-500"
              >
            ...
            <div className="space-y-2">
              <Label htmlFor="note" className="text-sm font-medium">Ghi Chú Đặc Biệt</Label>
              <Input
                id="note"
            ...
            <ShimmerButton type="submit" className="w-full py-3.5 font-bold tracking-wider text-sm shadow-xl">
      ...
      {/* SECTION 6: REVIEWS */}
      <section id="reviews" className="py-20 px-6 border-t border-border/40 bg-accent/10 overflow-hidden">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <Badge variant="outline" className="border-amber-500/30 text-amber-400">
              TESTIMONIALS
            </Badge>
            <h2 className="font-heading text-3xl sm:text-4xl font-bold">Cảm Nhận Khách Hàng</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
          ...
          <Marquee pauseOnHover className="[--duration:25s]">
            {REVIEWS.map((rev, idx) => (
              <Card key={idx} className="w-80 sm:w-96 bg-card/60 border-border p-6 mx-3 flex flex-col justify-between shrink-0 hover:border-amber-500/40 transition-colors">
                ...
                <div className="flex items-center gap-3 mt-6 pt-4 border-t border-border/40">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-amber-500/80 font-mono">{rev.role}</p>
                  </div>
                </div>
              </Card>
            ))}
      ...
      <footer id="contact" className="py-20 px-6 border-t border-border bg-background">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Nhận ngay ưu đãi 20% cho lần ghé thăm đầu tiên và ưu tiên đặt bàn đê.
            </p>
            <div className="flex gap-2">
              <Input placeholder="Email của bạn..." className="bg-accent/40 border-border text-xs" />
        ...
        <div className="max-w-6xl mx-auto border-t border-border/40 pt-8 flex flex-col sm:flex-row justify-between items-center text-xs text-muted-foreground gap-4">
